    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.logoWrap}>
          <Image
            source={require("../assets/images/gone.jpeg")}
        ...
        <View style={styles.card}>
          <View style={{ flexDirection: "row" }}>
            ...
            <View>
              <YesNoSwitch
                value={capitecAllowed}
                onChange={() =>
                  dispatch(
                    setSettings({
                      ...settings,
                      capitecAllowed: !capitecAllowed,
                    }),
                  )
                }
              />
          ...
          <TextField
            label="Capitec Error Message"
            value={capitecErrorMsg}
            onChangeText={(v) => {
        ...
        <View style={styles.card}>
          <View style={{ flexDirection: "row" }}>
            <View style={{ flex: 1 }}>
              <Text style={styles.title}>Send FNB Email</Text>
            </View>
            <View>
              <YesNoSwitch
                value={sendFnbEmail}
                onChange={() =>
                  dispatch(
                    setSettings({ ...settings, sendFnbEmail: !sendFnbEmail }),
                  )
                }
              />
            </View>
        ...
        <View style={[styles.card, { marginTop: 20 }]}>
          ...
          <View style={{ height: 12 }} />
          <TextField
            label="Immediate Error Message"
            value={immediateErrorMsg}
            onChangeText={(v) =>
              dispatch(setSettings({ ...settings, immediateErrorMsg: v }))
            }
          />
            ...
            <>
              ...
              <View style={{ flexDirection: "row" }}>
                <View style={{ flex: 1, paddingRight: 12 }}>
                  ...
                  >
                    You will have to send real money from a real account and
                    make sure that the real account has the money to be sent as
                ...
                <View style={{ marginTop: 16 }}>
                  <TextField
                    ...
                    onBlur={() => {
                      ...
                      if (accountInfo?.id) {
                        updateTable("users", accountInfo.id.toString(), {
                          immediateAmount: num,
                        });
                      }
                    }}
                  ...
                  <TextField
                    ...
                    onChangeText={(v) =>
                      dispatch(
                        setSettings({ ...settings, useRealMoneyErrorMsg: v }),
                      )
                    }
                  />
                </View>
