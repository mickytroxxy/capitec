    ...
    items: [
      {
        ...
        onPress: () => router.push("/pay-beneficiary"),
      },
      {
        id: "payshap",
        title: "PayShap",
        icon: { name: "grid", type: "Feather" },
        onPress: () => router.push("/cash-send"),
      },
      {
        id: "pay-bills",
        title: "Pay bills",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Buy electricity and water",
      ...
      },
      {
        ...
        icon: { name: "car", type: "FontAwesome" },
        isNew: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: { name: "compare-arrows", type: "MaterialIcons" },
      },
      {
        id: "recurring-future",
        title: "Recurring/future-dated",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "sars-efiling",
        title: "SARS eFiling",
        icon: { name: "percent", type: "Feather" },
      },
      {
        id: "load-account",
        title: "Load Account",
        icon: { name: "credit-card", type: "Feather" },
        onPress: () => router.push("/load-account"),
      },
      {
        id: "users",
        title: "Users",
        ...
        {groups.map((group, gIdx) => (
          <View key={group.id} style={styles.groupContainer}>
            {group.items.map((item, idx) => {
              if (item.id === "users" && accountInfo?.id != 1) return null;
