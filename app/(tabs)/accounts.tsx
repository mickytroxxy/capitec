...
export default function AccountsScreen() {
  ...
  const { activeTab, onlinePurchases, internationalTransactions, tapToPay } =
    ...
    <SafeAreaView style={styles.container}>
      <Stack.Screen
        options={{
          ...
          headerLeft: () => (
            <TouchableOpacity
              onPress={() => dispatch(setActiveTab("cards"))}
              style={{
                borderBottomWidth: activeTab === "cards" ? 3 : 0,
          ...
          headerRight: () => (
            <TouchableOpacity
              onPress={() => dispatch(setActiveTab("virtual"))}
              style={{
                borderBottomWidth: activeTab === "virtual" ? 3 : 0,
                borderBottomColor: colors.white,
                flex: 1,
                alignItems: "center",
                paddingVertical: 15,
            ...
            >
              <Text
                style={[
                  styles.tabText,
                  activeTab === "virtual" && styles.tabTextActive,
                ]}
              >
                Virtual Cards
              </Text>
        ...
        {activeTab === "cards" ? (
          <>
            ...
            <View style={styles.listBlock}>
              <View style={styles.row}>
                ...
                <YesNoSwitch
                  ...
                  onChange={(v) =>
                    dispatch(setToggle({ key: "onlinePurchases", value: v }))
                  }
                />
              </View>
              ...
              <View style={styles.row}>
                ...
                <YesNoSwitch
                  ...
                  onChange={(v) =>
                    dispatch(
                      setToggle({ key: "internationalTransactions", value: v }),
                    )
                  }
                />
              </View>
            ...
            <View style={styles.listBlock}>
              {/* Tap to pay */}
              <TouchableOpacity
                style={[styles.row, styles.tapRow]}
                activeOpacity={0.7}
                onPress={() =>
                  dispatch(setToggle({ key: "tapToPay", value: !tapToPay }))
                }
              >
                <View
                  style={{
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                onPress={() => {
                  router.push("/update-permanent-limits");
                }}
              >
                <View
                  style={{
