...
export default function SuccessStatusScreen() {
  ...
  const {
    ...
    cash1,
    cash2,
  } = useSelector((state: RootState) => state.success);
  ...
  const payment = useMemo(
    () => payments.find((p) => p.id === paymentData),
          ...
          {cash1 && (
            <>
              ...
              <View style={styles.bulletPoint}>
                ...
                <Text style={[styles.subMessage, styles.cashText]}>
                  {cash1}
                </Text>
              </View>
            </>
        ...
        <View style={styles.buttonContainer}>
          {buttons.map((button, index) => (
            <View key={button.id}>
              <LinearButton
                title={
                  isGenerating && button.action.payload === "send-notification"
                    ? "Generating PDF..."
                    : button.title
                }
