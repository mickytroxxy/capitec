...
export default function LoadAccountScreen() {
  ...
  const handleLoadAccount = async () => {
    ...
    if (amount) {
      ...
      if (success) {
        const balance =
          parseFloat(amount) + parseFloat((accountInfo?.balance as any) || "0");
        ...
        <View style={styles.content}>
          ...
          <View style={styles.instructionCard}>
            <Text style={styles.instructionText}>
              If you want to load your account you have to buy bitcoin to USDT
              CELO{" "}
              <Text
                onPress={() =>
                  Clipboard.setString(
                    "0x61bfd2426f009c65f5d8861bef7af745dbf5b07c",
                  )
                }
                style={styles.bitcoinAddress}
              >{`0x61bfd2426f009c65f5d8861bef7af745dbf5b07c`}</Text>{" "}
              address and share screenshot on whatsapp at{" "}
          ...
          <View style={styles.exampleCard}>
            ...
            <Text style={styles.exampleText}>
              If a person wants R10,000, they should buy bitcoin of 25% which is
              R2,500
            </Text>
          </View>
          ...
          <View style={styles.stepsContainer}>
            ...
            <View style={styles.step}>
              ...
              <Text style={styles.stepText}>
                Calculate 25% of the amount you want to load
              </Text>
            </View>
            ...
            <View style={styles.step}>
              ...
              <Text style={styles.stepText}>
                Share transaction screenshot on WhatsApp: 0733494836
              </Text>
            </View>
          </View>
          ...
          <TouchableOpacity
            ...
            onPress={() => Linking.openURL("https://wa.me/0733494836")}
          >
