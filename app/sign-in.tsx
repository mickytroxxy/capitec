    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View>
          ...
          <View
            style={{ position: "absolute", alignSelf: "center", bottom: 48 }}
          >
            <Text
              style={{
            ...
            >
              {accountInfo?.firstName?.toUpperCase()}
            </Text>
            <View
              style={{
                flexDirection: "row",
        ...
        >
          <LinearButton
            title="Sign In"
            onPress={() =>
              router.push({ pathname: "/enter-pin", params: { action: "old" } })
            }
          />
        </View>
      </ScrollView>
            ...
            <View>
              <Animated.View style={styles.btnCircleUp}>
                <TouchableOpacity style={styles.button} onPress={() => {}}>
                  <FontAwesome name={"qrcode"} color={colors.white} size={28} />
                </TouchableOpacity>
              </Animated.View>
              <Text style={{ marginTop: -15, fontFamily: Fonts.fontRegular }}>
                Scan to pay
              </Text>
            </View>
          )}
